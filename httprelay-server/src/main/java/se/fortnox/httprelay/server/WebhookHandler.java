...
public class WebhookHandler implements HandlerFunction<ServerResponse> {
    ...
    @Autowired
    public WebhookHandler(Environment env, ObjectMapper objectMapper) {
    ...
    public Mono<ServerResponse> handle(ServerRequest request) {
        return request
                ...
                .concatMap(dataBuffer -> validateSignature(request.headers(), dataBuffer))
                .concatMap(dataBuffer -> respondToEvent(request, dataBuffer))
                .next();
    }
